...
public class LiveDrawingView  extends SurfaceView implements Runnable {
    ...
    //This will be used to make simple buttons
    ...
    //The particle systems will be declared here
    ...
    public LiveDrawingView(Context context, int x, int y){
        ...
        //Initialize these two member/fields
        //With the values passed in as parameters
        mScreenX = x;
        mScreenY = y;

        //Font size is 5% (1/20th) of screen width
    ...
    //When we start the thread with mThread.start();
    ...
    public void run(){
        ...
        while (mDrawing){
            ...
            if (!mPaused){
                update();
                //Now the particles are in their positions
            }
            ...
            //because accidently dividing by 0 crashes the app
            if (timeThisFrame > 0){
    ...
    //This method is called by LiveDrawActivity when the user quits the app
    public void pause(){
    ...
    public boolean onTouchEvent(MotionEvent motionEvent){
        ...
        //User pressed the screen see if it was a button
    ...
    private void printDebuggingText(){
        ...
        //We will add more code here next chapter
